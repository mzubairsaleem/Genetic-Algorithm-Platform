...
var ConstantGene_1 = require("../sample-problems/AlgebraBlackBox/Genes/ConstantGene");
{
    describe("reduction", function () {
        it("should reduce simple summed parameters to minimum", function () {
            ...
            assert.equal(Environment_1.convertParameterToAlphabet(o.toString()), "(a-a)");
            var r = o.asReduced();
            assert.equal(Environment_1.convertParameterToAlphabet(r.toString()), "(0)");
        });
        it("should reduce to 1", function () {
            ...
            assert.equal(Environment_1.convertParameterToAlphabet(o.toString()), "(a/a)");
            var r = o.asReduced();
            assert.equal(Environment_1.convertParameterToAlphabet(r.toString()), "(1)");
        });
        it("should reduce simple summed parameters to minimum", function () {
            var o = new Operator_1.default(Operators.ADD);
            o.add(new ParameterGene_1.default(0));
            o.add(new ParameterGene_1.default(0, -1));
            o.add(new ParameterGene_1.default(0, -1));
            assert.equal(Environment_1.convertParameterToAlphabet(o.toString()), "(a-a-a)");
            var r = o.asReduced();
            assert.equal(Environment_1.convertParameterToAlphabet(r.toString()), "-(a)");
        });
        it("should keep sign appropriately", function () {
            ...
            assert.equal(Environment_1.convertParameterToAlphabet(o.toString()), "((a*a)-b)");
            var r = o.asReduced();
            assert.equal(Environment_1.convertParameterToAlphabet(r.toString()), "((a*a)-b)");
        });
        it("should reduce constants", function () {
            ...
            assert.equal(Environment_1.convertParameterToAlphabet(o.toString()), "((a*a)-b+3+2)");
            var r = o.asReduced();
            assert.equal(Environment_1.convertParameterToAlphabet(r.toString()), "((a*a)-b+5)");
        });
        it("should reduce eliminate zero", function () {
            ...
            assert.equal(Environment_1.convertParameterToAlphabet(o.toString()), "((a*a)-b+3+2-1-4)");
            var r = o.asReduced();
            assert.equal(Environment_1.convertParameterToAlphabet(r.toString()), "((a*a)-b)");
        });
    });
