...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", "./Triangular", "typescript-dotnet/source/System/Disposable/dispose", "typescript-dotnet/source/System/Collections/LinkedList", "typescript-dotnet/source/System/Tasks/TaskHandlerBase", "./Population", "typescript-dotnet/source/System.Linq/Linq"], factory);
    }
    ...
    var Environment = (function (_super) {
        ...
        function Environment(_genomeFactory) {
            ...
            this._populationsEnumerable
                = Linq_1.Enumerable.from(this._populations = new LinkedList_1.LinkedList());
        }
